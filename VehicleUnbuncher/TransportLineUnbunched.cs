...
{
    public class TransportLineUnbunched
    {
        public Dictionary<ushort, VehicleUnchunched> Vehicles = new Dictionary<ushort, VehicleUnchunched>();

        public void RefreshTransportLine(ushort LineID)
        {
            ...
            VehicleUnbuncherManager.RefreshDuplicatedPositions();
        }
    }
}
